...
public class JpaMain_6 {
    public static void main(String[] args) {
        ...
        try {
            tr.begin();
            //객체지향 스럽지 않음
            Ch5_4Team team = new Ch5_4Team();
            team.setName("TeamA");
            em.persist(team);

            Ch5_4Member member = new Ch5_4Member();
...
//            em.clear();
            ...
            Ch5_4Team findTeam = em.find(Ch5_4Team.class, team.getId()); //1차 캐시
            List<Ch5_4Member> members = findTeam.getMembers();
