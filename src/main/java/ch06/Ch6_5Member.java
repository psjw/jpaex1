...
//    @JoinTable(name = "Ch6_5MEMBER_PRODUCT") //만약 자동으로 생성하면 다른 값을 넣을수 없어서 엔티티로 생성한다
    @JoinTable(name = "Ch6_5MEMBER_PRODUCT_ENTITY") //만약 자동으로 생성하면 다른 값을 넣을수 없어서 엔티티로 생성한다
    private List<Ch6_5Product> products = new ArrayList<>();
